; (function ($, undefined) {
    ...
    Part.prototype.show = function(){
        var self = this;
        if (self.collapsed) {
            self.element.find(".part-content").show();
            self.element.find(".part-command").show();
            ...
            self.element.find(".part-title i").toggleClass("hidden-icon");
        };
    };
    ...
    Part.prototype.close = function(){
        ...
        if (!self.collapsed) {
            ...
            self.element.animate({
                ...
                self.options.duration, "easeOutCubic",
                function () {
                    self.element.find(".part-content").hide();
